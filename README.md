...
- 🎯 Entry points to execute your program using `python -m <skogapi>` or `$ skogapi` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/Skogix/SkogAPI/branch/main/graph/badge.svg?token=SkogAPI_token_here)](https://codecov.io/gh/Skogix/SkogAPI)
[![CI](https://github.com/Skogix/SkogAPI/actions/workflows/main.yml/badge.svg)](https://github.com/Skogix/SkogAPI/actions/workflows/main.yml)

Awesome skogapi created by Skogix

## Install

from source
```bash
git clone https://github.com/Skogix/SkogAPI skogapi
cd skogapi
make install
```
...
```bash
$ skogapi run --port 8080
```

or

```bash
python -m skogapi run --port 8080
```
...
```bash
❯ skogapi --help
Usage: skogapi [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ skogapi create-user --help
Usage: skogapi create-user [OPTIONS] USERNAME PASSWORD
...
```bash
skogapi create-user admin admin --superuser
```
...
Run with `skogapi run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `skogapi create-user`.
...
-----------------------------------------------------
skogapi/__init__.py              4      0   100%
skogapi/app.py                  16      1    94%
skogapi/cli.py                  21      0   100%
skogapi/config.py                5      0   100%
skogapi/db.py                   10      0   100%
skogapi/models/__init__.py       0      0   100%
skogapi/models/content.py       47      1    98%
skogapi/routes/__init__.py      11      0   100%
skogapi/routes/content.py       52     25    52%
skogapi/routes/security.py      15      1    93%
skogapi/routes/user.py          52     26    50%
skogapi/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in skogapi/default.toml.
